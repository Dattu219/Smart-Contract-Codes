...
contract UnicornBase is UnicornAccessControl {
    ...
    // §ä.§Ö. ID §å§ß§Ú§Ü§à§â§ß§Ñ => §á§à§â§ñ§Õ§Ü§à§Ó§í§Û §ß§à§Þ§Ö§â §Ó §ã§á§Ú§ã§Ü§Ö §Ó§Ý§Ñ§Õ§Ö§Ý§î§è§Ñ
    ...
    */
    ...
    function approve(address _to, uint256 _unicornId) public onlyOwnerOf(_unicornId) {
        ...
        //§Þ§à§Õ§Ú§æ§Ú§Ü§Ñ§ä§à§â onlyOwnerOf §Ô§Ñ§â§Ñ§ß§ä§Ú§â§å§Ö§ä, §é§ä§à owner = msg.sender
    ...
    */
    ...
    function minusTourFreezingTime(uint _unicornId, uint64 _time) onlyBreeding public {
        ...
        //§ß§Ö §Ú§ã§á§à§Ý§î§Ù§å§Ö§Þ safeMath, §ä.§Ü. subTourFreezingTime §Ó §ä§Ö§à§â§Ú§Ú §ß§Ö §Õ§à§Ý§Ø§Ö§ß §Ò§í§ä§î §Ò§à§Ý§î§ê§Ö now %)
